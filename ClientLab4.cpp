...
// nvcc -c ClientLab4.cu -o ClientLab4CUDA.o
// g++ -o ClientLab4.o -c ClientLab4.cpp
// g++ -o ClientLab4 ClientLab4.o ClientLab4CUDA.o -L/usr/local/cuda/lib64 -lpthread -lboost_program_options -lcuda -lcudart
...
int main(int argc, char* argv[]) {
    ...
    // main buisness calcs
    vector<vector<double>> result_vector = get_max_cuda(matrix_vector, calcs_time);
